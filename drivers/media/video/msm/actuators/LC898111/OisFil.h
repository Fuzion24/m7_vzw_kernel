...
/*the time and date : 2013/5/14 15:12:27*/
/*FC filename : 20130318_H03_G01-5-3-GP07*/
/*fs,23438Hz*/
/*LSI No.,LC898111_A*/
/*Comment,*/
...
{ 0x1843, 0x3B515235},/*3B515235,1843,LPF,0.3Hz,38dB,fs/1,invert=0*/
{ 0x1844, 0x3B515235},/*3B515235,1844,LPF,0.3Hz,38dB,fs/1,invert=0*/
{ 0x1845, 0x3F7FFABB},/*3F7FFABB,1845,LPF,0.3Hz,38dB,fs/1,invert=0*/
{ 0x1846, 0x3CAE6500},/*3CAE6500,1846,LPF,2Hz,38dB,fs/1,invert=0*/
{ 0x1847, 0x3CAE6500},/*3CAE6500,1847,LPF,2Hz,38dB,fs/1,invert=0*/
{ 0x1848, 0x3F7FDCDF},/*3F7FDCDF,1848,LPF,2Hz,38dB,fs/1,invert=0*/
...
{ 0x184C, 0x3BAE6DFA},/*3BAE6DFA,184C,LPF,0.5Hz,38dB,fs/1,invert=0*/
{ 0x184D, 0x3BAE6DFA},/*3BAE6DFA,184D,LPF,0.5Hz,38dB,fs/1,invert=0*/
{ 0x184E, 0x3F7FF737},/*3F7FF737,184E,LPF,0.5Hz,38dB,fs/1,invert=0*/
...
{ 0x1853, 0x3507E2AE},/*3507E2AE,1853,LPF,0.3Hz,-38dB,fs/1,invert=0*/
{ 0x1854, 0x3507E2AE},/*3507E2AE,1854,LPF,0.3Hz,-38dB,fs/1,invert=0*/
{ 0x1855, 0x3F7FFABB},/*3F7FFABB,1855,LPF,0.3Hz,-38dB,fs/1,invert=0*/
{ 0x1856, 0x36626C97},/*36626C97,1856,LPF,2Hz,-38dB,fs/1,invert=0*/
{ 0x1857, 0x36626C97},/*36626C97,1857,LPF,2Hz,-38dB,fs/1,invert=0*/
{ 0x1858, 0x3F7FDCDF},/*3F7FDCDF,1858,LPF,2Hz,-38dB,fs/1,invert=0*/
...
{ 0x185C, 0x3562783E},/*3562783E,185C,LPF,0.5Hz,-38dB,fs/1,invert=0*/
{ 0x185D, 0x3562783E},/*3562783E,185D,LPF,0.5Hz,-38dB,fs/1,invert=0*/
{ 0x185E, 0x3F7FF737},/*3F7FF737,185E,LPF,0.5Hz,-38dB,fs/1,invert=0*/
...
{ 0x1894, 0x3DCCCCCD},/*3DCCCCCD,1894,-20dB,invert=0*/
...
{ 0x1943, 0x3B515235},/*3B515235,1943,LPF,0.3Hz,38dB,fs/1,invert=0*/
{ 0x1944, 0x3B515235},/*3B515235,1944,LPF,0.3Hz,38dB,fs/1,invert=0*/
{ 0x1945, 0x3F7FFABB},/*3F7FFABB,1945,LPF,0.3Hz,38dB,fs/1,invert=0*/
{ 0x1946, 0x3CAE6500},/*3CAE6500,1946,LPF,2Hz,38dB,fs/1,invert=0*/
{ 0x1947, 0x3CAE6500},/*3CAE6500,1947,LPF,2Hz,38dB,fs/1,invert=0*/
{ 0x1948, 0x3F7FDCDF},/*3F7FDCDF,1948,LPF,2Hz,38dB,fs/1,invert=0*/
...
{ 0x194C, 0x3BAE6DFA},/*3BAE6DFA,194C,LPF,0.5Hz,38dB,fs/1,invert=0*/
{ 0x194D, 0x3BAE6DFA},/*3BAE6DFA,194D,LPF,0.5Hz,38dB,fs/1,invert=0*/
{ 0x194E, 0x3F7FF737},/*3F7FF737,194E,LPF,0.5Hz,38dB,fs/1,invert=0*/
...
{ 0x1953, 0x3507E2AE},/*3507E2AE,1953,LPF,0.3Hz,-38dB,fs/1,invert=0*/
{ 0x1954, 0x3507E2AE},/*3507E2AE,1954,LPF,0.3Hz,-38dB,fs/1,invert=0*/
{ 0x1955, 0x3F7FFABB},/*3F7FFABB,1955,LPF,0.3Hz,-38dB,fs/1,invert=0*/
{ 0x1956, 0x36626C97},/*36626C97,1956,LPF,2Hz,-38dB,fs/1,invert=0*/
{ 0x1957, 0x36626C97},/*36626C97,1957,LPF,2Hz,-38dB,fs/1,invert=0*/
{ 0x1958, 0x3F7FDCDF},/*3F7FDCDF,1958,LPF,2Hz,-38dB,fs/1,invert=0*/
...
{ 0x195C, 0x3562783E},/*3562783E,195C,LPF,0.5Hz,-38dB,fs/1,invert=0*/
{ 0x195D, 0x3562783E},/*3562783E,195D,LPF,0.5Hz,-38dB,fs/1,invert=0*/
{ 0x195E, 0x3F7FF737},/*3F7FF737,195E,LPF,0.5Hz,-38dB,fs/1,invert=0*/
...
{ 0x1994, 0x3DCCCCCD},/*3DCCCCCD,1994,-20dB,invert=0*/
